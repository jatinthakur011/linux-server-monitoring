...
**Linux Server Monitoring & Auto-Recovery** | Bash, Ubuntu, AWS EC2, Nginx, Cron

- Developed a Bash-based Linux monitoring system to track CPU, memory, disk utilization, and critical services including Nginx and SSH.
- Implemented automated Nginx failure detection and service recovery using `systemctl`, with recovery status recorded in server logs.
- Configured Cron-based execution to automate server health checks and performed failure testing by intentionally stopping Nginx and validating successful recovery.

---

## 🎤 Interview Explanation

If an interviewer asks: *"Explain your second project."*

A strong answer:

> "I built a Linux Server Monitoring and Auto-Recovery system using Bash on an Ubuntu EC2 instance. The purpose was to demonstrate how a Linux server can be monitored automatically instead of relying on manual checks. My monitoring script checks CPU, RAM, disk usage and important services such as Nginx and SSH. I implemented logging and an auto-recovery mechanism for Nginx. During testing, I intentionally stopped Nginx, the script detected that the service was inactive, attempted to restart it, and verified that it became active again. I also configured Cron to execute the monitoring script every five minutes."

---

## 🔥 Project 1 + Project 2

These two projects now complement each other very well.

**Project 1 — Build & Secure**
...
This gives you a much stronger story than having two unrelated Linux projects.
